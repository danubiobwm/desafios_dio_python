...
def menu():
    """
    Mostra o menu de opções e solicita a escolha do usuário.
    """
    menu_text = """
    ================ MENU ================
    [d]\tDepositar
...
def sacar(saldo, valor, extrato, limite, numero_saques, limite_saques):
    """
    Realiza a operação de saque e atualiza o extrato.
    """
...
def filtrar_usuario(cpf, usuarios):
    """
    Filtra um usuário na lista de usuários pelo CPF.
    """
...
def criar_conta(agencia, numero_conta, usuarios):
    """
    Cria uma nova conta associada a um usuário.
    """
